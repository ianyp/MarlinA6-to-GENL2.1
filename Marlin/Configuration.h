...
#define STRING_CONFIG_H_AUTHOR "Ian Pett" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "SCAR"
...
#define Z_CLEARANCE_BETWEEN_PROBES  60 // Z Clearance between probe points
